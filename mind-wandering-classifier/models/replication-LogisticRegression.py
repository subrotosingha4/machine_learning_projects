...
a LogisticRegression classifier meta-parameters.  The goal is to
replicate (approximately) the configuration and results of the
...
def main():
    ...
    result_dir = '.'
    output_file = 'replication-LogisticRegression.pkl'
